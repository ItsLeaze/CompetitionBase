...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, 0, 900, 0, 0, -180, 0, (10 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, -400, 50, -800, 0, 0, 0, (1 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 400, 50, -800, 0, 0, 0, (2 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -800, 50, -1600, 0, 0, 0, (3 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 0, 50, -1600, 0, 0, 0, (4 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 800, 50, -1600, 0, 0, 0, (5 << 16), bhvWarpPipe),
		OBJECT(MODEL_WOODEN_SIGNPOST, 350, 50, -200, 0, -90, 0, (1 << 24), bhvMessagePanel),
