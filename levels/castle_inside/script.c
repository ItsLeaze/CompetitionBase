...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -400, 50, -400, 0, 0, 0, (1 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 400, 50, -600, 0, 0, 0, (2 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -400, 50, -800, 0, 0, 0, (3 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 400, 50, -1000, 0, 0, 0, (4 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -400, 50, -1200, 0, 0, 0, (5 << 16), bhvWarpPipe),
		TERRAIN(castle_inside_area_1_collision),
		MACRO_OBJECTS(castle_inside_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_DS_CASINO),
